...
import com.vivokey.vivoauth.exc.AppletSelectException
import com.vivokey.vivoauth.exc.StorageFullException
import com.vivokey.vivoauth.exc.UnsupportedAppletException
import com.vivokey.vivoauth.transport.ApduError
...
constructor(private var backend: Backend) : Closeable {
    ...
    companion object {
        ...
        // VivoKey AID: A0 00 00 07 47 00 61 FC 54 D5
        private val AID = byteArrayOf(0xA0.toByte(), 0x00, 0x00, 0x07, 0x47, 0x00, 0x61, 0xFC.toByte(), 0x54, 0xD5.toByte())
